...
def tests_to_run(forwarder,filename):
    from tests import BasicTest, RandomDropTest, RandomDupTest, OutOfOrderTest, SackRandomDropTest, SackRandomDupTest, SackOutOfOrderTest
    BasicTest.BasicTest(forwarder, filename)
    RandomDropTest.RandomDropTest(forwarder, filename)
    RandomDupTest.RandomDupTest(forwarder, filename)
    OutOfOrderTest.OutOfOrderTest(forwarder, filename)
    SackRandomDropTest.SackRandomDropTest(forwarder, filename)
    SackRandomDupTest.SackRandomDupTest(forwarder, filename)
